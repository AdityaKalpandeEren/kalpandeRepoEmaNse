...
def check_vwap_retest(symbol: str, df: pd.DataFrame) -> Optional[RetestSignal]:
    ...
    candle. Uses NSE's session VWAP (cumulative from market open), unlike
...
# VWAP. Uses RetestSignal / _candle_aggressor unchanged. Ported over
# unchanged from the US bot so both bots run the identical VWAP test
# logic. Delete this function (and its call site in scan_once.py /
# main.py) to revert - nothing above this line was touched.
# ═══════════════════════════════════════════════════════════════════
