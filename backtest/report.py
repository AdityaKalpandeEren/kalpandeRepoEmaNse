...
report - overall, and broken down by strategy and by symbol. Shared by
backtest/run_backtest.py and paper_trading/generate_report.py so both
report the exact same numbers the exact same way.
"""
import os
...
def write_report(trades: list, out_dir: str, label: str = "backtest") -> dict:
